...
GOOGLE_API_KEY = os.getenv("AIzaSyDI7pcFS0F1q9t37i5J0s16uKUejiwFCIo")
...
def is_relevant_question(question):
    keywords = ["fitness", "exercise", "workout", "training", "nutrition", "diet", "meal", "calories", "protein"]
    return any(keyword in question.lower() for keyword in keywords)

# Display the chatbot's title on the page
st.title("Gemini Pro - Your Fitness Trainer and Nutritionist")
...
user_prompt = st.chat_input("Ask Gemini-Pro about fitness or nutrition...")
if user_prompt:
